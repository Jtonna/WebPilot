...
- [DESIGN_AND_UX.md](DESIGN_AND_UX.md) -- Web UI design system, palette, visual craft, and information architecture. Single source of truth for the look-and-feel of the server-hosted web UI at `/ui`.
